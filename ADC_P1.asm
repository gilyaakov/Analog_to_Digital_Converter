...
;               and output it to DAC0 by using Timer 2 interrupt.
;               The ADC operate in single conversation mode.
...
CSEG AT 0100H
   TR2_ISR:
           SETB SCONV ;Set to initiate single conversation cycle.
           CLR TF2       
		   RETI
CSEG AT 0200H
  ADCI_ISR:
...
CSEG AT 0300H
    START:
		...
		MOV ADCCON1,#10111000b ;Power on ADC, set it to use the internal 
                               ...
                               ;conversation bit to 0 (the program do it manually), set 
